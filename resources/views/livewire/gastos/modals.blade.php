    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Create New Gasto</h5>
           ...
           <div class="modal-body">
				<form>
                    ...
                    <div class="form-group">
                        <label for="ticket_gastos"></label>
                        <input wire:model="ticket_gastos" type="text" class="form-control" id="ticket_gastos" placeholder="Ticket Gastos">@error('ticket_gastos') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="factura_gastos"></label>
                        <input wire:model="factura_gastos" type="text" class="form-control" id="factura_gastos" placeholder="Factura Gastos">@error('factura_gastos') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
...
<div wire:ignore.self class="modal fade" id="updateDataModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateModalLabel">Update Gasto</h5>
                <button wire:click.prevent="cancel()" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form>
